...
export class SellerCampaignController {
  ...
  @Post(
    'clasica/:itemId/promociones/seller-campaign',
  )
  createClassic(
    @Param('itemId') itemId: string,
    @Body() changes: SellerCampaignUpdate,
  ) {
    return this.sellerCampaignService.createClassic(
      itemId,
      changes,
    );
  }
  ...
  updateClassic(
    ...
    return this.sellerCampaignService.updateClassic(
      itemId,
      changes,
    );
  }
  ...
  @Delete(
    'clasica/:itemId/promociones/seller-campaign/:promotionId',
  )
  deleteClassic(
    @Param('itemId') itemId: string,
  ...
  @Post(
    'nueva/:familyId/items/:itemId/promociones/seller-campaign',
  )
  createNew(
